...
public class main {
	...
	public static void main(String[] args) throws Exception {
		...
		t = new Table();  //each table keeps track of the pizza or pizzas served on it.
		...
		p1 = new Pizza(new pizzaStrategy1(), "Large", "Thin", t, 13);  //topping are  Mushrooms, Onions, Green Peppers and Black Olives

		p2 = new Pizza(new pizzaStrategy2(), "Large", "Thin", t, 15);  //topping are  Steak and Pepperoni
	...
	public static void input(Pizza p2){
